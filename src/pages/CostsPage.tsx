    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <p className="text-slate-400 text-sm mb-10 italic">
          {t('Alapszintű mikroökonómia — a pékségtől a profitmaximalizálásig', 'Introductory microeconomics — from the bakery to profit maximization')}
        </p>

        <div className="flex flex-col gap-3">
          {game.levels.map((level, i) => (
            <Link key={level.id} to={`/games/costs/level/${level.id}`}
