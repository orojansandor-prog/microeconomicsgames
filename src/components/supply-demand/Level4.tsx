        ...
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1">
              ...
              <Link to="/games/supply-demand/level/4" className="w-7 h-7 rounded-lg flex items-center justify-center text-xs font-bold transition-colors bg-indigo-600 text-white shadow-sm">4</Link>
            </div>
          </div>
        </div>
      </div>
